...
class PessoasControllerTest < ActionController::TestCase
  ...
  test "should create pessoa" do
    assert_difference('Pessoa.count') do
      post :create, pessoa: { email: @pessoa.email, nome: @pessoa.nome, string,: @pessoa.string,, string: @pessoa.string }
    end
  ...
  test "should update pessoa" do
    put :update, id: @pessoa, pessoa: { email: @pessoa.email, nome: @pessoa.nome, string,: @pessoa.string,, string: @pessoa.string }
    assert_redirected_to pessoa_path(assigns(:pessoa))
  end
